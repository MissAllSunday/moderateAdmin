...
$txt['mA_edit'] = 'Edit a message';
$txt['mA_edit_sub'] = 'Check this option if you want the mod to cover editing a message. This includes editing polls as well.';
$txt['mA_delete'] = 'Check this option if you want the mod to cover deleting a message. Delete a message';
$txt['mA_delete_sub'] = 'This includes deleting polls as well.';
$txt['mA_move'] = 'Move a message';
$txt['mA_move_sub'] = 'Check this option if you want the mod to cover moving a message. This includes moving polls as well.';