...
$txt['mA_coverOptions'] = 'Check the cases where you want this mod to work, if you don\'t want to restrict the users from moving your topics, uncheck that option. The option includes its poll counterpart as well.';
$txt['mA_edit'] = 'Edit/Modify a message';
$txt['mA_delete'] = 'Delete a message';
$txt['mA_move'] = 'Move a message';
$txt['mA_sticky'] = 'Set a message as unsticky/sticky';
$txt['mA_lock'] = 'Unlock/Lock a topic';
$txt['mA_merge'] = 'Split/Merge a topic';
