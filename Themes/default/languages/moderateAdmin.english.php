...
$txt['mA_coverOptions'] = 'Check the cases where you want this mod to work, if you don\'t want to restrict the users from moving your topics, uncheck that option.';
$txt['mA_edit'] = 'Edit a message';
$txt['mA_edit_sub'] = 'This includes editing polls as well.';
$txt['mA_delete'] = 'Delete a message';
$txt['mA_delete_sub'] = 'This includes deleting polls as well.';
$txt['mA_move'] = 'Move a message';
$txt['mA_move_sub'] = 'This includes moving polls as well.';
